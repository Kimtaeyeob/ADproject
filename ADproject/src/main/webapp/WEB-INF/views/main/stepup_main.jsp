...
<link
	...
	function dlmode() {
	    ...
	    if (isDarkMode) {
	    	...
	    	logoicon.src = '/par/resources/img/logo.png';
	    	...
	    	logoicon.src = "/par/resources/img/logo_light.png"
	    }
	}
	</script>
	<script>
	...
	<link rel="stylesheet" href="/ad/resources/css/main.css">
</head>
	<body>
		...
		<header>
			...
			<div class="logo">
				...
				<img id="logoIcon" src="/par/resources/img/logo.png" class="logo-img"
					width="60px">
			</div>
		...
		<!-- 사이드 메뉴2 -->
				<div class="stu">
					...
					<div class="ac_icon">
						<div class="stu-icon">
							<img class="stu_icon_i" src="/par/resources/img/메가스터디.png"
