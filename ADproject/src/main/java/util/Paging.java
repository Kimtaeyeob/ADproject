...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			...
			sb.append("'><img src='/a/resources/img/btn_prev.gif'/></a>");
		}
		else
			sb.append("<img src='/a/resources/img/btn_prev.gif'/>");
...
//-----그룹페이지처리 다음 ----------------------------------------------------------------------------------------------
		if(isNextPage){
			...
			sb.append(endPage + 1);
			sb.append("&"+search_param);
			sb.append("'><img src='/a/resources/img/btn_next.gif'/></a>");
		}
		else
			sb.append("<img src='/a/resources/img/btn_next.gif'/>");
//---------------------------------------------------------------------------------------------------------------------	    
